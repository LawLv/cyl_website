          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-center space-x-4 group hover-lift p-4 rounded-lg transition-all duration-200">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-3 p-2 rounded hover:bg-gray-50 transition-colors duration-200">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors duration-200"
                >
