          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="cursor-target flex items-center space-x-4 group hover-lift p-4 rounded-lg transition-all duration-200">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="cursor-target flex items-center space-x-3 p-2 rounded hover:bg-gray-50 transition-colors duration-200">
                  <div className="text-xl">🎾</div>
                  <span className="text-gray-600">Tennis, Fitness, Swimming</span>
                </div>
                <div className="cursor-target flex items-center space-x-3 p-2 rounded hover:bg-gray-50 transition-colors duration-200">
                  <div className="text-xl">🎬</div>
                  <span className="text-gray-600">Watching movies, Coding, FPS games</span>
                </div>
                <div className="cursor-target flex items-center space-x-3 p-2 rounded hover:bg-gray-50 transition-colors duration-200">
                  <div className="text-xl">🎵</div>
                  <span className="text-gray-600">Playing music</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="cursor-target w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors duration-200"
                >
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="cursor-target w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
